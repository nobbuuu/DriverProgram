...
public class MassLoadingMoreFooter extends LoadingMoreFooter {
    ...
    public MassLoadingMoreFooter(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public MassLoadingMoreFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
