...
/*        mTextView.setPadding(DensityUtils.dip2px(getContext(), 20), DensityUtils.dip2px(getContext(), 20),
                DensityUtils.dip2px(getContext(), 20), DensityUtils.dip2px(getContext(), 20));//alec*/
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTextView.setPadding(mSlideIcon.getMeasuredHeight(), 0, mSlideIcon.getMeasuredHeight(), 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIconX + mDistanceX > 0) {
            ...
            //和彩色图的圆角保持一致
            canvas.drawRoundRect(rectF, DensityUtils.dip2px(getContext(), 2), DensityUtils.dip2px(getContext(), 2), mSecondaryPaint);
...
//            canvas.drawText(mBgText == null ? "":mBgText, getMeasuredWidth() / 2, baselineY, mBgTextPaint);
    ...
    private class SlideIcon extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // 绘制文字
            canvas.drawText(mIconText == null ? "" : mIconText, (float) getMeasuredWidth() / 2, baselineY, mTextPaint);
        }
