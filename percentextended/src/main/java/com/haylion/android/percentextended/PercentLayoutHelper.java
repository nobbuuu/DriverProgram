...
package com.haylion.android.percentextended;
...
public class PercentLayoutHelper {
    ...
    public static PercentLayoutInfo getPercentLayoutInfo(Context context,
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout);
    ...
    private static PercentLayoutInfo setWidthAndHeightVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_widthPercent, true);
        if (percentVal != null) {
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_heightPercent, false);
    ...
    private static PercentLayoutInfo setTextSizeSupportVal(TypedArray array, PercentLayoutInfo info) {
        ...
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_textSizePercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
    ...
    private static PercentLayoutInfo setMinMaxWidthHeightRelatedVal(TypedArray array, PercentLayoutInfo info) {
        ...
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_maxWidthPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
        ...
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_maxHeightPercent,
                false);
        if (percentVal != null) {
            info = checkForInfoExists(info);
        ...
        //minWidth
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_minWidthPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
        ...
        //minHeight
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_minHeightPercent,
                false);
        if (percentVal != null) {
            info = checkForInfoExists(info);
    ...
    private static PercentLayoutInfo setMarginRelatedVal(TypedArray array, PercentLayoutInfo info) {
        ...
        PercentLayoutInfo.PercentVal percentVal =
                getPercentVal(array,
                        com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginPercent,
                        true);
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginLeftPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginTopPercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginRightPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginBottomPercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginStartPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_marginEndPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
    ...
    private static PercentLayoutInfo setPaddingRelatedVal(TypedArray array, PercentLayoutInfo info) {
        //默认padding以宽度为标准
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_paddingPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
        ...
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_paddingLeftPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
            info.paddingLeftPercent = percentVal;
        ...
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_paddingRightPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
            info.paddingRightPercent = percentVal;
        ...
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_paddingTopPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
            info.paddingTopPercent = percentVal;
        ...
        percentVal = getPercentVal(array,
                com.haylion.android.percentextended.R.styleable.PercentLayout_Layout_layout_paddingBottomPercent,
                true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
            info.paddingBottomPercent = percentVal;
